                            ...
                            <div class="float-right">
                                    <form method="GET" action="{{ route('Kategori.index') }}">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Cari dengan nama" name="nama_kategori">
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table">
                                        ...
                                        @foreach ($kategoriobat as $index=>$kategori)
                                            <tr>
                                                <td>{{ $index + $kategoriobat->firstItem() }} </td>
                                ...
                                <div class="float-right">
                                    {{ $kategoriobat->withQueryString()->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
